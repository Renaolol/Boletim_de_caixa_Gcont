...
exportar_pdf = st.download_button(label="Baixar PDF", data=gera_pdf(display_df,
                                  ...
                                  file_name=f"{get_nome_portador(empresa,portador_select)[0][0]}.pdf"
...
with pd.ExcelWriter(buffer,engine="xlsxwriter") as writer:
    ...
    worksheet = writer.sheets["Lanctos"]
    worksheet.write(1,1,f"{get_nome_portador(empresa,portador_select)[0][0]}")
@st.fragment()
def baixa_excel():
